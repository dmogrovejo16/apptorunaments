...
@Component({
  selector: 'app-create-futbol-match-second-adm',
  templateUrl: './create-futbol-match-second-adm.page.html',
  styleUrls: ['./create-futbol-match-second-adm.page.scss'],
})
export class CreateFutbolMatchSecondAdmPage implements OnInit {
