...
@Component({
  selector: 'app-create-basquet-match-third-adm',
  templateUrl: './create-basquet-match-third-adm.page.html',
  styleUrls: ['./create-basquet-match-third-adm.page.scss'],
})
export class CreateBasquetMatchThirdAdmPage implements OnInit {
