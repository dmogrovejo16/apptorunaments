...
@Component({
  selector: 'app-create-basquet-match-second-adm',
  templateUrl: './create-basquet-match-second-adm.page.html',
  styleUrls: ['./create-basquet-match-second-adm.page.scss'],
})
export class CreateBasquetMatchSecondAdmPage implements OnInit {
